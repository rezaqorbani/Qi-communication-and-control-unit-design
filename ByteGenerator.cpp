...
{
  m_bit_array[0] = '0';
  m_bit_array[1] = init_array[7];
  m_bit_array[2] = init_array[6];
  m_bit_array[3] = init_array[5];
  m_bit_array[4] = init_array[4];
  m_bit_array[5] = init_array[3];
  m_bit_array[6] = init_array[2];
  m_bit_array[7] = init_array[1];
  m_bit_array[8] = init_array[0];
  m_bit_array[9] = this->get_parity();
  m_bit_array[10] = '1';
}
